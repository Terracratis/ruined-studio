...
function rsizer()
		...
		$("#Delete").click(function(){
			if (confirm("Tikrai norite ištrinti produktą?\nProduktas bus pašalintas ir iš menių sarašų.\nNebebus galima pasiekti produkto pardavimo istorijos."))
				{
					showAlert("Trinama.");
					$.post("{ROOT_STUDIO}/editor.php",{id: "product-add/delete",value: "<?=$draft['product_id']?>"}).done(function(data){if(data == "OK"){window.location="{URL}/products"}showAlert(data);});
				}
		});
	});
